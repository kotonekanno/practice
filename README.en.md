...
- [Highlights](#highlights)
  ...
  - [Number Guessing Game (Highly Recommend!)](#number-guessing-game-highly-recommend)
  - [zodiac Sign Checker](#zodiac-sign-checker)
...
### [zodiac Sign Checker](python/04-1_v2.py)  
- Tells the zodiac sign based on the entered birth date  
- A simple web app version is also available in another repository: [Zoardic Checker](https://github.com/kotonekanno/zodiac-checker)  
- Written in Python 
...
├── 4-1_v1.py                # zodiac sign checker version 1  
├── 4-1_v2.py                # zodiac sign checker version 2  
